var OpenWeatherAppKey = "8bcb7e7257a8e621a858ae0281fdb8f3";

function getWeatherWithZipCode() {
    var zipcode = $('#zip-code-input').val();
    var queryString =
        'http://api.openweathermap.org/data/2.5/weather?zip=' + zipcode + ',can&appid=' + OpenWeatherAppKey + '&units=metric&lang=fr';
...
function getWeatherWithGeoLocation() {
    ...
    $('#error-msg').show();
    $('#error-msg').text('Détermination de la position courante ...');
